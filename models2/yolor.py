...
from .yolor_utils import *
from .yolor_torch_utils import scale_img, fuse_conv_and_bn, model_info, is_parallel
...
class YOLOv4(Yolor):
    def __init__(self, img_size=(512, 512), verbose=False):
        super().__init__('cfg/yolo_v4.cfg', img_size, verbose)

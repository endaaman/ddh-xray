...
class Experiment(Commander):
    ...
    def run_thres(self):
        ...
        texts += [
            plt.text(x, y, f'{s} threshold={th:.3f}', fontstyle='italic', color='black')
            for (x, y, th, s) in ((x_youden, y_youden, threshold_youden, 'Youden'),
                              (x_topleft, y_topleft, threshold_topleft,  'top-left'),
                              (x_f1, y_f1, threshold_f1, 'f1'))
        ]
        for t in texts:
